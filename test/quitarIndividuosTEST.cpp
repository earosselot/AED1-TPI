...
TEST(quitarIndividuosTEST, SacaUnIndividuoNingunHogar) {
    ...
    eph_i ti = {
            {22010, 1,  2020, 0, 3, 1, 65, 1, 2, 15000, 8},  // cumple
            {22010, 7,  2020, 0, 3, 2, 22, 0, 0, 10000, 10},
            {22010, 9,  2020, 0, 3, 1, 9,  0, 0, 0,     10},
            {22010, 10, 2020, 0, 3, 2, 9,  0, 0, 0,     10},
            {22010, 11, 2020, 0, 3, 2, 2,  0, 0, 0,     10},
            {22010, 12, 2020, 0, 3, 2, 17, 0, 0, 0,     10},
            {20101, 1,  2020, 0, 3, 2, 46, 1, 3, 3900,  0},
            {20101, 2,  2020, 0, 3, 1, 24, 0, 3, 6000,  10},
    };
    ...
    individuo ind = {22010, 1, 2020, 0, 3, 1, 65, 1, 2, 15000, 8};
