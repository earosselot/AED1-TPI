...
TEST(ordenarRegionYCODUSUTEST, mismaRegion) {
    ...
    eph_i ti = {
            {334, 1, 2017, 1, 0, 1, 36, 1, 3, 16300, 1},
            {650, 2, 2017, 1, 1, 2, 34, 1, 4, 14323, 1},
            {960, 3, 2017, 1, 1, 2, 51, 1, 4, 1280,  1},
            {650, 1, 2017, 1, 1, 2, 23, 1, 4, 0,     1},
            {960, 2, 2017, 1, 0, 2, 20, 1, 3, 7000,  1},
            {960, 1, 2017, 1, 0, 2, 19, 0, 0, 0,     6},
...
TEST(ordenarRegionYCODUSUTEST, muchasRegiones) {
    ...
    eph_i ti = {
            {334, 1, 2017, 1, 0, 1, 36, 1, 3, 16300, 1},
            {123, 2, 2017, 1, 1, 2, 34, 1, 4, 14323, 1},
            {747, 3, 2017, 1, 1, 2, 51, 1, 4, 1280,  1},
            {457, 1, 2017, 1, 1, 2, 23, 1, 4, 0,     1},
            {954, 2, 2017, 1, 0, 2, 20, 1, 3, 7000,  1},
            {347, 1, 2017, 1, 0, 2, 19, 0, 0, 0,     6},
    };
